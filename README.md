### What is this?
This is a project used to learn how to build a react app, as well as building a simple blockchain that gets saved incase the server shuts down, and also has an API.
